...
export const adProviderEnum      = pgEnum("ad_provider",      ["google_adsense", "google_ad_manager"]) // google_ad_manager retained in DB enum but no longer used
...
export const readerProfiles = pgTable("reader_profiles", {
  ...
  crossPublisherInterests:  jsonb("cross_publisher_interests").notNull().default(sql`'{}'::jsonb`),
