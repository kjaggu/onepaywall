...
| OnePaywall billing — enforcement (Session 2c) | `done` | Trigger.dev scheduled task `trigger/billing-enforcement.ts` (hourly); suspends past-due/expired-trial publishers; gate trigger quota enforcement; monthly overage charge calculation |
