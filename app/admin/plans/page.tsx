const PLANS = [
  {
    ...
    mauPerDomain: "5,000",
    gates: 2,
    features: ["1 domain", "5,000 MAU / domain", "2 gates", "Basic analytics", "Auto-converts to Lite after 30 days"],
    subscribers: 6,
    mrr: "—",
    active: true,
  },
  ...
  },
  {
    ...
    mauPerDomain: "25,000",
    gates: 10,
    features: ["3 domains", "25,000 MAU / domain", "10 gates", "Full analytics", "Audience intelligence", "Priority email support"],
    subscribers: 14,
    mrr: "₹41,986",
    active: true,
  },
  {
    ...
    gates: "Unlimited",
    features: ["10 domains", "1,00,000 MAU / domain", "Unlimited gates", "Full analytics + audience intelligence", "Reader revenue reports", "Slack support"],
    subscribers: 9,
    mrr: "₹71,991",
    active: true,
  },
