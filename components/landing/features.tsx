...
const FEATURES = [
  {
    ...
    body: "Six gate types — paywall, ad, unlock, lead capture, product, newsletter — triggered by the reader's segment and visit history. The right ask, at the right moment, to the right reader.",
    href: "/features/gates",
  },
  {
    icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
    title: "Reader Intelligence",
    body: "Every visitor gets a live profile: engagement score, monetization probability, and segment (new / casual / regular / power user). No login required. No cookies needed.",
    href: "/features/intelligence",
  },
  {
    icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
    title: "Full Analytics Suite",
    body: "See exactly where readers drop off, which gates convert, and which content drives subscriptions — all in one place, not split across three tools.",
  ...
  },
  {
    ...
    title: "Ad Management",
    body: "Gate non-subscribers with a pre-roll ad or display unit. Earn from readers who won't subscribe — without losing them permanently.",
    href: "/features/ads",
  },
  {
    icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z",
    title: "Email & CRM",
    body: "Trigger campaigns on reader behavior: segment change, first unlock, ad skip, or new subscription. Send with your existing Mailchimp or ConvertKit — or use webhooks.",
    href: "/features/email",
  },
]
      ...
      <div className="lp-container">
        <div ref={headRef} className="lp-reveal" style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 style={{ fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 800, color: "var(--color-text)", margin: 0, letterSpacing: "-0.03em", lineHeight: 1.1 }}>
            Every reader.{" "}
            <span className="lp-gradient-text">A different revenue stream.</span>
          </h2>
        </div>
